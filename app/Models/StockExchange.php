...
class StockExchange extends Model implements Auditable{
    ...
    'warranty_date','serial_numbers', 'status','issue_qty','req_qty','req_send_user_id','req_aprove_user_id','req_send_shop_id','req_receive_shop_id',
    ...
    function productAvailableShopWise(){
        $shopID = 1;
        return $this->belongsTo(ProductAvailable::class,'product_id')->where('shop_id', $shopID);
    }
