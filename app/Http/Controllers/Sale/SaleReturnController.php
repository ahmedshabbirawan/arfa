        ...
        function index(Request $request){
            if($request->ajax()){
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $action .= '<a href="'.route('sale.sale_return.detail',$row->id).'" class="btn btn-sm btn-success" data-toggle="tooltip" title="Detail" ><i class="ace-icon fa fa-eye bigger-120"></i></a>';
                    $action .= '</div>';
                    return $action;
