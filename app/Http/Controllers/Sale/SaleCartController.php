        ...
        if($request->ajax()){
            if($for == 'ajax'){
                ...
                ->addColumn('discount', function ($row){
                    ...
                    $dd =  '<a href="javascript:void(0);" onclick="deleteCartItem('.$row->id.');" class="btn btn-danger btn-icon avtar-s mb-0" data-toggle="tooltip" title="Delete" ><i class="fas fa-trash-alt"></i></a>';
                    return $dd;
                })
