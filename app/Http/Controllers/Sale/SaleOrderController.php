        ...
        function index(Request $request){
            if($request->ajax()){
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $action .= '<a href="'.route('sale.order.detail',$row->id).'" class="btn btn-sm btn-success" data-toggle="tooltip" title="Detail" ><i class="ace-icon fa fa-eye bigger-120"></i></a>';
                    $action .= '<a href="'.route('sale.order.sale_return_view',$row->id).'" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Sale Return" ><i class="ace-icon fa fa-undo bigger-120"></i></a>';
