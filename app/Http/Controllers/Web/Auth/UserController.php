            ...
            return DataTables::of($data)
                ->addColumn('action', function ($row) {
                  ...
                  //    $action .= '<a href="'.route('product.view', $row->id).'" class="btn btn-xs btn-success" data-toggle="tooltip" title="Detail" ><i class="ace-icon fa fa-eye bigger-120"></i></a>';
                     $action .= '<a href="'. route('usermanagement.user.edit', ['id' => $row->id]) .'" class="btn btn-sm btn-info"  data-toggle="tooltip" title="Edit" ><i class="ace-icon fa fa-pencil-alt bigger-120"></i></a>';
                     $action .= '<a href="'.route('usermanagement.user.status', ['id' => $row->id]).'"  class="btn btn-sm btn-warning" data-toggle="tooltip" title="Change Status" ><i class="ace-icon '.$statusIcon.' bigger-120"></i></a>';
                     $action .= '<a href="javascript:void(0);"  class="btn btn-sm btn-warning" data-toggle="tooltip" title="Change Role" onclick="pos_app.showRoleAssignFormModal('.$row->id.');" ><i class="ace-icon fa fa-user bigger-120"></i></a>';
                    ...
                    $action .= '<a href="javascript:void(0);" onclick="pos_app.showChangePasswordModal('.$row->id.')"  class="btn btn-sm btn-success" data-toggle="tooltip" title="Change Password" ><i class="ace-icon fa fa-lock bigger-120"></i></a>';
                     $action .= '</div>';
                    return $action;
                })
                ->addIndexColumn()
