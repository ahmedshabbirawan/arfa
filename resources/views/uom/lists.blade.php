    ...
    <div class="page-content">
        ...
        <div class="page-header" style="min-height:40px;">
            <div class="" style="float: left;">
                <h1> Measure Units <small> <i class="ace-icon fa fa-angle-double-right"></i> List </small></h1>
            </div>
...
@section('script')
    <script>
        ...
        function doChangeStatus(objID) {
            var changeURL = "{{ route('Settings.uom.changeStatus','') }}";
            $.ajax({
                dataType: 'json',
                type: 'get',
                url: changeURL + '/' + objID,
            ...
            $.confirm({
                ...
                buttons: {
                    yes: {
                        text: 'Yes',
                        action: function () {
                            var changeURL = "{{ route('Settings.uom.index') }}";
                            // alert(changeURL);
