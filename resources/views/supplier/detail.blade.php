    ...
    <div class="row ">
        <div class="col-12 col-lg-12" style="margin-top:20px;">
            ...
            <div class="card radius-10 border-top border-0 border-4 border-danger">
                <div class="card-body">
                    <a href="{{ route('supplier.list') }}" class="btn btn-xs btn-light bigger"><i class="ace-icon "></i>
                        Back </a>
                </div>
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body" style="display: block;">
                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> NTN</div>
                                        <div class="profile-info-value">
                                            <span class="editable editable-click" id="username">{{ $row->ntn }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click" id="username">{{ $row->phone }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click" id="username">{{ $row->fax }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click"
                                                  id="username">{!!$row->status_label!!}</span>
                                        </div>
                                    </div>
