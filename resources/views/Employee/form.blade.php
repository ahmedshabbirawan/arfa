...
<div class="row ">
    <div class="col-12 col-lg-12" style="margin-top:20px;">
        ...
        <div class="card radius-10 border-top border-0 border-4 border-danger">
            ...
            <form method="post"
                  action="{{ isset($employee) ? route('Settings.employee.update', $employee->id) : route('Settings.employee.store') }}"
                                ...
                                <div class="widget-main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <input type="text"
                                                   class="col-xs-10 col-sm-5 form-control @error('first_name') is-invalid @enderror"
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <input type="text"
                                                   class="col-xs-10 col-sm-5 form-control @error('last_name') is-invalid @enderror"
                                                   value="{{old('last_name', (isset($employee))? $employee->last_name : '' )}}"
                                                   name="last_name" id="last_name" placeholder="First Name">
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <input type="text"
                                                   class="col-xs-10 col-sm-5 form-control @error('cnic') is-invalid @enderror"
                                                   value="{{old('cnic',(isset($employee))? $employee->cnic : '' ) }}"
                                                   name="cnic" id="cnic" placeholder="email">
                                        </div>
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <input type="text"
                                                   class="col-xs-10 col-sm-5 form-control @error('mobile') is-invalid @enderror"
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <select name="project_id"
                                                    class="col-xs-10 col-sm-5 form-control @error('project_id') is-invalid @enderror">
                                                <option value="#"> -- Select --</option>
