                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <div>
                                    ...
                                    <textarea placeholder="Type remarks here....." name="remarks"
                            ...
                            <div class="tabbable">
                                <ul class="nav nav-tabs padding-18">
                                    <li class="active"><a data-toggle="tab" href="#home"> <i
                                                class="green ace-icon fa fa-user bigger-120"></i> Profile </a></li>
                                    <li><a data-toggle="tab" href="#feed"> <i
                                                class="orange ace-icon fa fa-rss bigger-120"></i> Inventory Activity
                                        </a></li>
                                    @can('item_return.create')
                                        <li><a data-toggle="tab" href="#return_tab"> <i
                                                    class="orange ace-icon fa fa-undo bigger-120"></i> Return Form
                                            </a></li>
                                    @endcan
                                </ul>
