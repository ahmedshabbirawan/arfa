    ...
    <div class="page-content">
        ...
        <div class="page-header" style="min-height:40px;">
            ...
            <div class="" style="float: right;">
                ...
                <a href="javascript:void(0);" onclick="sync_remote_data();" class="btn btn-xs btn-light bigger"><i
                        class="ace-icon fa fa-floppy-o"></i> Sync Data </a>

                <a href="{{$adminURL.'/create'}}" class="btn btn-xs btn-light bigger"><i
    ...
    <script>
        ...
        function sync_remote_data() {
            let dialog = bootbox.dialog({
                message: "<span class='bigger-110'>Please wait while system fetch data from HRIS</span>",
                closeButton: false
            });
            $.ajax({
                dataType: 'json',
