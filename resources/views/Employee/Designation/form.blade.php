...
<div class="row ">
    <div class="col-12 col-lg-12" style="margin-top:20px;">
        ...
        <div class="card radius-10 border-top border-0 border-4 border-danger">
            ...
            <form method="post"
                  action="{{ isset($designation) ? route('Settings.designations.update', $designation->id) : route('Settings.designations.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="{{ $colClass }}">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{old('name', (isset($designation->name))? $designation->name : '' )}}"
