                    ...
                    <div class="col-lg-12">
                        <div class="">
                            ...
                            <table width="100%" border="0">
                                <tr class="">
                                    <td width="120"><img src="{{asset('assets/images/logo/logo.jpg')}}" width="120"/>
                                    </td>
                                    ...
                                    <td width="120"><img src="{{asset('assets/images/logo/logo-icon.png')}}"
                                                         width="120"/></td>
                                </tr>
                                <tr>
                                    <td colspan="3">&nbsp;</td>
                                ...
                                <tr class="hidden">
                                    <td colspan="3">
                                        <div class="col-lg-6 col-sm-12 no-print">
                                            ...
                                            <div><input type="file" name="return_report_file" id="return_report_file"/>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="">
                                    <td colspan="3">
                                        <table width="100%" border="0">
                                            <tr>
                                                <td width="150" colspan="3" class="text-uppercase"><b>Received BY</b>&nbsp;&nbsp;
                                                </td>
                    ...
                    <div class="row clearfix form-actions no-print ">
                        <div class="col-sm-2 text-left">
                            <a href="{{ route('return.list') }}"
                               class="btn btn-xs btn-primary bigger hard_copy no-print"><i
                        ...
                        <div class="col-sm-10 text-right">
                            ...
                            <a href="javascript:void(0);" onclick="submit_return_form();"
                               class="hidden btn btn-xs btn-primary bigger hard_copy no-print"><i
                                    class="ace-icon fa fa-upload"></i> Submit Return Form </a>
                        </div>
                    </div><!-- /.row -->
                </div>
        </div>
