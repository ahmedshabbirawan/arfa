                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="customer_id"
                                                        id="customer_select2"></select>
                                                <span class="input-group-addon"
                                                      onclick="pos_app.showCreateCustomerModal();"
                        ...
                        <div class="widget-header">
                            ...
                            <div class="widget-toolbar">
                                <a href="javascript:void(0);" onclick="pos_app.showOnHoldListModal();"
                                   class="btn btn-xs btn-light bigger"><i class="ace-icon fa fa-plus-o"></i> OnHolds
                                </a>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-search bigger-110"></i></span>
                                            <select class="form-control" name="product_select2"
                                                    id="product_select2"></select>
                                        </div>
                                    </div>
                                </div>
                            </div>
