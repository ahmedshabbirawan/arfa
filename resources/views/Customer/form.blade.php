                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   ...
                                                   value="{{old('cnic' , (isset($customer))? $customer->cnic : '' ) }}"
                                                   name="cnic" id="cnic" placeholder="NTN">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="address" id="address"
                                                      ...
                                                      id="form-field-8"
                                                      placeholder="Address">{{old('address', (isset($customer))? $customer->address : '' ) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="info" id="info"
                                                      ...
                                                      id="form-field-8"
                                                      placeholder="Address">{{old('info', (isset($customer))? $customer->info : '' ) }}</textarea>
                                        </div>
                                    </div>
