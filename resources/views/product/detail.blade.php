        ...
        <div class="container py-5">
            <div class="media col-md-10 col-lg-8 col-xl-7 p-0 my-4 mx-auto" style="    margin: 40px 10px;">
                ...
                <div class="media-body" style="width:10%">
                    <h4 class="font-weight-bold mb-4"><i class="menu-icon ace-icon glyphicon glyphicon-qrcode"
                                                         style="font-size: 40px;"></i></h4>
                </div>
                            ...
                            <div class="widget-header">
                                ...
                                <div class="col-xs-2 col-sm-2 text-right">
                                    <a href="{{ route('supplier.list') }}"
                                       class="btn btn-xs btn-light bigger right-text"><i class="ace-icon "></i> Back
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click"
                                                  id="username">{{ $row->description }}</span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click"
                                                  id="username">{{ (isset($row->uom->name))?$row->uom->name:'' }}</span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click"
                                                  id="username">{{ $row->threshold_qty }}</span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
