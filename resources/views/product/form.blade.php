                            ...
                            <div class="widget-body" style="display: block;">
                                ...
                                <div class="widget-main">
                                        ...
                                        <div>
                                            <select name="sub_cat_id" id="sub_category_id"
                                                ...
                                                <optgroup label="<?= $cat->name ?>">
                                                    ...
                                                    <option value="<?= $subCat->id ?>" <?= ($subCat->id == $subCategoryID) ? 'selected="selected"' : '' ?> ><?= $subCat->name ?></option> <?php } ?>
                                    ...
                                    <div class="col-lg-4 col-sm-4">
                                        ...
                                        <div class="">
                                            <select name="uom_id" id="uom_id" data-placeholder="Select UOM"
                                                    class="col-xs-10 col-sm-5 form-control chosen-select" required>
                                                <option value=""></option>
                                    ...
                                    <div class="container" id="attr_heading" style="margin-left:0px; display:none;">
                                        <div class="row justify-content-center"
                                             style="border-bottom: solid 1px; border-color: lightgrey; margin:14px 0px;">
                                            <b>Attribute</b></div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-4" style="display: none;">
                                        ...
                                        <div class="">
                                            <input type="text"
                                                   class="col-xs-10 col-sm-5 form-control @error('threshold_qty') is-invalid @enderror"
                                                   value="{{ old('threshold_qty') }}" name="threshold_qty"
                                                   id="threshold_qty" placeholder="Threshold Quantity">
                                        </div>
                                    </div>
