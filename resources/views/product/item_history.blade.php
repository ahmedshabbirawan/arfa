            ...
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="profile-user-info profile-user-info-striped">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value"><span>{{ $categories['category']['name'] }} / {{ $categories['sub_category']['name'] }} / {{ $categories['product_category']['name'] }}</span>
                        </div>
                    </div>
                    <div class="profile-info-row">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value"><span>{{(isset($row->uom->name))?$row->uom->name:'' }}</span>
                        </div>
                    </div>
                    <div class="profile-info-row">
                        <div class="profile-info-name"> Created Date & Time</div>
                        <div class="profile-info-value"><span>{{ (isset($row->created_at))?$row->created_at:'' }}</span>
                        </div>
                    </div>
                    <div class="profile-info-row">
                        ...
                        <div class="timeline-items">
                            <div class="timeline-item clearfix">
                                ...
                                <div class="widget-box transparent">
                                    <div class="widget-header widget-header-small"><h5 class="widget-title smaller">
                                            Return</h5></div>
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            Item Return by <a href="#"
                                                              class="blue">{{ $hisRow->employee->full_name }}</a>
        ...
        <div class="row hidden">
            <div class="col-sm-12">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered yajratable" id="item_history_table"
