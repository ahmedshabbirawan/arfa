<div class="row ">
    <div class="col-12 col-lg-12" style="margin-top:20px;">
        ...
        <div class="card radius-10 border-top border-0 border-4 border-danger">
            ...
            <form method="post"
                  action="{{ isset($project) ? route('Settings.project.update', $project->id) : route('Settings.project.store') }}"
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body" style="display: block;">
                                <div class="widget-main">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   ...
                                                   value="{{old('code', (isset($project)) ? $project->code : '' )}}"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> DG /
                                            ADG </label>
                                        <div class="col-sm-9">
