        ...
        <div class="row ">
            <div class="col-12 col-lg-12" style="margin-top:20px;">
                ...
                <div class="card radius-10 border-top border-0 border-4 border-danger">
                    ...
                    <form method="post" action="{{ route('Settings.warehouse.update',$row->id) }}" novalidate
                                    ...
                                    <div class="widget-body" style="display: block;">
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"
                                                           class="col-xs-10 col-sm-5 form-control @error('code') is-invalid @enderror"
                                                           value="{{ (old('code'))?old('code'):$row->code }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea
                                                        ...
                                                        placeholder="Address">{{old('address',$row->address )}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    {{ \App\Util\Form::statusSelect(old('status'), $row->status) }}
