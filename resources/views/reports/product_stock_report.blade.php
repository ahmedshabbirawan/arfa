                        ...
                        <div class="widget-main">
                            ...
                            <form name="filterForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        ...
                                        <div>
                                            <select name="sub_category_id" id="sub_category_id_bluk"
                                                    class="chosen-select form-control select_chosen select21" required
                                                    style="width:100%">
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        ...
                                        <div><select name="product_category_id" id="product_category_id_bluk"
                                                     class="form-control select_chosen select21" required>
                                                <option value=""> -- All --</option>
                                            </select>
                                        </div>
                                    </div>
                         ...
                         select21" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        <label>DG</label>
                                        <select name="dg_id" id="dg_id" onchange="getProjectByDG(this.value);"
                                                class="col-lg-12 select_chosen select21">
                                            <option value=""> -- All --</option>
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        ...
                                        <select name="project_id" id="project_id"
                                                class="col-lg-12 select_chosen select21" multiple="multiple">
                                    ...
                                    <span class="input-group-addon">
                                        <i><input type="checkbox" class="stock_item_input" name="date_range_cb"
                                                  id="date_range_cb" value="yes" onchange="date_range_cb_check();"></i></span>
            ...
            function initDataTableRecord() {
                table = $('#yajra-table').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'product_available_sum_qty',
                            name: 'product_available_sum_qty',
                            title: 'Available',
                            'width': '20px'
                        },
                        {
                            data: 'stock_delivery_product_sum_quantity',
                            name: 'stock_delivery_product_sum_quantity',
                            title: 'Available',
                            'width': '20px'
                        }
                    ],
