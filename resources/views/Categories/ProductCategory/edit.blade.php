                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="POST"
                              action="{{route('category.product.update',['id'=>$productCategory->id])}}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="pos-rel">
                                        <select class="form-control" name="parentCategoryName" id="CategoryName"
                                                required>
                                            <option hidden value="">Select Parent Category</option>
                                            @foreach ( $ParentCategories as $ParentCategory )
                                                <option
                                                    value="{{$ParentCategory->id}}"{{$ParentCategory->id == $productCategory->parentCategoryId? 'selected':''}}>{{$ParentCategory->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="food">Enter
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <input type="text" name="name" class="form-control"
                                           value="{{$productCategory->name}}" size="24"
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="food">Enable
                                    Alerts</label>
                                <div class="col-xs-12 col-sm-9">
                                    <div class="control-group">
                                        <div class="radio">
                                            <label>
                                                <input name="enable_alert" value="1" type="radio"
                                                       class="ace" <?= ($productCategory->enable_alert == 1) ? 'checked="checked"' : '' ?> >
                                                <span class="lbl"> Yes </span>
                                            </label>
                                            <label>
                                                <input name="enable_alert" value="0" type="radio"
                                                       class="ace" <?= ($productCategory->enable_alert != 1) ? 'checked="checked"' : '' ?> >
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="food">Serial
                                    Number Required</label>
                                <div class="col-xs-12 col-sm-9">
                                    <div class="control-group">
                                        <div class="radio">
                                            <label>
                                                <input name="sn_require" value="1"
                                                       <?= ($productCategory->sn_require == 1) ? 'checked="checked"' : '' ?> type="radio"
                                                       class="ace">
                                                <span class="lbl"> Yes </span>
                                            </label>
                                            <label>
                                                <input name="sn_require" value="0"
                                                       <?= ($productCategory->sn_require == 0) ? 'checked="checked"' : '' ?> type="radio"
                                                       class="ace">
                                                <span class="lbl"> No </span>
                                            </label>
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-top" for="duallist"> Product Category
                                    Attributes</label>
                                ...
                                <div class="col-sm-8">
                                    <select multiple="multiple" size="10" name="duallistbox_demo1[]" id="duallist">
                                        @foreach($productCategoryAttributes As $productCategoryAttribute)
                                            <option
                                                value="{{$productCategoryAttribute->id}}" {{in_array($productCategoryAttribute->id,$productCategoryAttributesArray)?'selected':''}}>{{$productCategoryAttribute->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
