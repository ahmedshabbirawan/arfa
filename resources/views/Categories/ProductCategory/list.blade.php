                ...
                <div class="card radius-10 border-top border-0 border-4 border-danger">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="yajra-table" class="table table-bordered table-hover" style="width:100%">
                                <thead>
                                <tr>
                                    <th class="center">SR</th>
                                    <th class="center">Parent Category Name</th>
                                    <th class="center">Sub Category Name</th>
                                    <th class="center">Product Category Name</th>
                                    <th class="center">Category Attribute</th>
        ...
        $(document).ready(function () {
            var table = $('#yajra-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'SubCategoryName', name: 'SubCategoryName', "className": "dt-center"},
                    {data: 'name', name: 'name', "className": "dt-center"},
                    {data: 'CategoryAttributes', name: 'CategoryAttributes', "className": "dt-center"},
