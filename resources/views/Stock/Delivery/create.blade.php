                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="col-lg-12 chosen_select"
                                                    required>
                        ...
                        <div class="widget-main">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-3">
                                    ...
                                    <div>
                                        <select name="shop_id" id="shop_id" class="chosen-select form-control select21"
        ...
        function submitDeliveryForm() {
            ...
            if (errorCount == 0) {
                $.ajax({
                    ...
                    url: "{{ route('stocks.delivery.save') }}",
