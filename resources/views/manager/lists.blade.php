    ...
    <div class="page-content">
        <div class="page-header" style="min-height:40px;">
            ...
            <div class="" style="float: right;">
                <a href="{{ route('Settings.manager.create') }}" class="btn btn-xs btn-light bigger"><i
...
@section('script')
    <script>
            ...
            $.confirm({
                ...
                buttons: {
                    yes: {
                        text: 'Yes',
                        action: function () {
                            var changeURL = "{{ route('Settings.manager.delete','') }}";
                            // alert(changeURL);
        ...
        function doChangeStatus(objID) {
            var changeURL = "{{ route('Settings.manager.status','') }}";
            $.ajax({
                dataType: 'json',
                type: 'get',
                url: changeURL + '/' + objID,
        ...
        $(document).ready(function () {
            ...
            table = $('#yajra-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('Settings.manager.list') }}",
                columns: [
