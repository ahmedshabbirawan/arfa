<div class="row ">
    <div class="col-12 col-lg-12" style="margin-top:20px;">
        ...
        <div class="card radius-10 border-top border-0 border-4 border-danger">
            ...
            <form method="post"
                  action="{{ isset($manager) ? route('Settings.manager.update', $manager->id) : route('Settings.manager.store') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   ...
                                                   value="{{old('mobile', (isset($manager))? $manager->mobile : '' )}}"
                                                   required name="mobile" id="mobile" placeholder="Mobile">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   ...
                                                   required name="email" id="email" placeholder="Email Address">
                                        </div>
                                    </div>
